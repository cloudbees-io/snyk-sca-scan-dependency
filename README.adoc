...
[WARNING]
====
*DEPRECATED:* This workflow is now legacy and deprecated. Please use :https://github.com/cloudbees-io/snyk-sca-plugin[snyk-sca-plugin] instead. This legacy workflow will be retired on September 30th, 2026.
====
